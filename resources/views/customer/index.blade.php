...
<section class="bg-gray-100">
  <div class="container mx-auto py-40 relative">
    <h1 class="mt-2 text-4xl font-bold font-heading text-center">犬に癒やしてもらいませんか？</h1>
    <p class="text-center pt-5">犬の可愛い仕草、自由気ままな雰囲気を見ることはもちろん、<br>
      ただ同じ空間にいるだけでも癒やされます<br>
      当店自慢のフワッフワの犬に触れ合うことで「幸せホルモン」が補給しませんか？</p>
    ...
    <div class="w-full lg:w-1/3 p-3">
      <div class="bg-gray-100 rounded shadow">
        <div class="flex py-10 px-6">
          ...
          <div class="ml-4 w-56">
            <h3 class="mb-1 text-2xl font-heading text-left text-blue-500">犬の体調管理</h3>
...
<section class="mt-24">
  <div class="container mx-auto">
    ...
    <h2 class="mt-2 font-bold font-heading text-center text-3xl">ほぼ毎日お店で犬の様子をお届け！！</h2>
        ...
        <div class="border rounded-lg overflow-hidden shadow">
          ...
          <div class="pt-2 pb-4 px-4">
            <a href="#">
              ...
              <p class="mb-6 text-gray-500 leading-relaxed text-left truncate">実はわんカフェはリモートワークやコワーキングとしても大活躍....</p>
            </a>
            <div class="flex justify-between">
              <ul class="flex">
                <li class="bg-gray-100 text-gray-400 text-xs mr-2 py-1 px-2">＃わんちゃん</li>
  ...
  <div class="container mx-auto">
    ...
    <div class="md:flex justify-center">
      ...
      <div class="text-left lg:ml-8 px-8">
        <p class="font-bold text-3xl pb-5">わんカフェ</p>
        <dl>
          ...
          <dd class="text-lg pl-12">〒123-4567<br>東京都中央区晴海5-6-5</dd>
          <dt class="mt-5 text-xl font-medium">最寄り駅から</dt>
          <dd class="pl-12 text-lg">都営大江戸線「勝どき駅」<span class="ml-6">徒歩5分</span></dd>
        </dl>
      </div>
    </div>
  </div>

...
<section>
    <div class="mb-6 py-4 bg-white rounded">
        <div class="flex px-6 pb-4 border-b">
            ...
            <div class="ml-auto">
                <a href="/admin/menus/create" class="py-2 px-3 text-xs text-white font-semibold bg-indigo-500 rounded-md">新規メニュー</a>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr @class(['text-sm', 'bg-gray-50' => $loop->odd])>
                        <td class="flex px-4 py-3 items-center">
                            <img class="w-12 h-12 mr-4 object-cover rounded-md" src="{{ asset('storage/'. $menu->image) }}" alt="">
                            <p class="font-medium"> <a href="{{ route('admin.menus.edit', $menu) }}">{{ $menu->name }}</a>
                        </td>
                        <td>¥{{ $menu->price }}円</td>
                        <td>{{ $menu->updated_at }}</td>
                        <td>
                            <div class="flex">
                                <a class="mr-2" href="{{ route('admin.menus.edit', $menu) }}">

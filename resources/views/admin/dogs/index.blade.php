                ...
                <tbody>
                    ...
                    <tr @class(['text-sm', 'bg-gray-50' => $loop->odd])>
                        <td class="flex px-4 py-3 items-center">
                            ...
                            <p class="font-medium"> <a href="{{ route('admin.dogs.edit', $dog) }}">{{ $dog->name }}</a></p>
                        </td>
                        <td>{{ $dog->updated_at }}</td>
                        <td>
                            <div class="flex">
                                <a class="mr-2" href="{{ route('admin.dogs.edit', $dog) }}">
                                ...
                                <form action="{{ route('admin.dogs.destroy', $dog) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button>

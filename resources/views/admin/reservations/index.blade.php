                ...
                <tbody>
                    ...
                    <tr @class(['text-sm', 'bg-gray-50' => $loop->odd])>
                        <td class="flex px-4 py-3 items-center">
                            <p class="font-medium"> <a href="{{ route('admin.reservations.show', ['reservation' => $reservation->id]) }}">{{ $reservation->name }}</a>
                        </td>
                        <td>{{ $reservation->reserved_date }}</td>
                        <td>{{ $reservation->updated_at }}</td>
                        <td>
                            <div class="flex">
                                <a class="mr-2" href="{{ route('admin.reservations.show', ['reservation' => $reservation->id]) }}">

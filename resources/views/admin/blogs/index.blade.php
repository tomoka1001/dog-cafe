                ...
                <tbody>
                    ...
                    <tr @class(['text-sm', 'bg-gray-50' => $loop->odd])>
                        <td class="flex px-4 py-3 items-center">
                            ...
                            <p class="font-medium"> <a href={{ route('admin.blogs.edit', ['blog' => $blog->id]) }}>{{ $blog->title }}</a>
                        </td>
                        <td>{{ $blog->staff->name ?? '未設定' }}</td>
                        <td>{{ $blog->updated_at }}</td>
                        <td>
                            <div class="flex">
                                <a class="mr-2" href={{ route('admin.blogs.destroy', ['blog' => $blog->id]) }}>

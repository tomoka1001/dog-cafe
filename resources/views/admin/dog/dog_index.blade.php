...
<section>
    <div class="mb-6 py-4 bg-white rounded">
        <div class="flex px-6 pb-4 border-b">
            ...
            <div class="ml-auto">
                <a href="/admin/dog/dog_create" class="py-2 px-3 text-xs text-white font-semibold bg-indigo-500 rounded-md">新規投稿</a>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr @class(['text-sm', 'bg-gray-50' => $loop->odd])>
                        <td class="flex px-4 py-3 items-center">
                            ...
                            <p class="font-medium"> <a href={{ route('admin/dog/dog_edit', ['dog' => $dog->id]) }}>{{ $dog->name }}</a>
                        </td>
                        ...
                        <td>
                            <div class="flex">
                                <a class="mr-2" href={{ route('admin/dog/dog_edit', ['dog' => $dog->id]) }}>

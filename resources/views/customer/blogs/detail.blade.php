...
<section class="bg-gray-100 pt-2">
  <div class="container mx-auto">
    <p class="text-left px-4 pt-2 text-gray-400"><a href="#" class="text-blue-600 hover:underline">トップ</a><span class="px-2">&gt</span><a href="#" class="text-blue-600 hover:underline">ブログ</a><span class="px-2">&gt</span>リモートワークにも！</p>
...
<section class="mt-24">
  <div class="container mx-auto">
    ...
    <div class="mb-10 pt-5 flex">
      ...
      <div class="pl-10">
        <h4 class="text-xl font-medium">犬好きなのに実家ではペットが飼えなかったのが理由でワンカフェ店員に！</h4>
